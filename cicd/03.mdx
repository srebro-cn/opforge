...
2. **性能优化配置**
   ```bash
   # 建议的JVM参数配置
   JAVA_OPTS="-Xmx4g -Xms4g -XX:+UseG1GC -XX:+ExplicitGCInvokesConcurrent -Djava.awt.headless=true"
   ```
...
查看`/home/application/jenkins/secrets/initialAdminPassword`文件，获取初始密码，输入密码登录
